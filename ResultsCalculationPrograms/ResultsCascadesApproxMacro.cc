...
#include "CascadeSignalEstimationApprox.cc"					//inclding CREDO macro
...
void ResultsCascadesApproxMacro(string current_dir) {				//Start MACRO
  ...
  */
  ...
  CascadeSignalEstimationApprox(I_criterium, params_dir, plots_dir, E_max, R_maximum, e_max, Aprime, eff, n, Tdet, f_fake, Tp, fi, eps, eps_phi, n_rand);	//Here the macro CascadeSignalEstimation is kick-started
